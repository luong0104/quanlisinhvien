<%-- 
    ...
    Created on : Oct 16, 2022, 10:32:34 PM
    Author     : havan
--%>
...
<body>
    ...
    <header>
        ...
        <nav class="navbar">
            ...
            <a href="dishes.jsp">Điểm</a>
            <a href="menu.jsp">Sinh Viên</a>
            <a href="review.jsp">Điểm</a>
            <a class="active"  href="schedule.jsp">Thời Khóa Biểu</a>
...
<section class="dishes" id="dishes">
    ...
    <h3 class="sub-heading"> Thông Tin TKB</h3>
